...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      githubUrl: "https://github.com/evanbourgoine/microservices",
      liveUrl: undefined,
    ...
    {
      title: "CI/CD Pipeline Montioring Dashboard",
      ...
      image: "/projects/cicd_dashboard.png",
      slug: "cicd-monitoring-dashboard",
    },
  ];
